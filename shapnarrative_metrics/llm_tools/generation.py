...
class GenerationModel:
    ...
    def generate_story_prompt(self, iloc_pos, num_feat=4 ,sentence_limit=10, prompt_type="long",manipulate=False):
    ...
    def generate_stories(self, model, x, y, tree=True, prompt_type="long", num_feat=4, manipulate=False):  
        """
        ...
        for i in range(len(x)):
            ...
            story_prompt=self.generate_story_prompt(i, prompt_type=prompt_type, num_feat=num_feat, manipulate=manipulate) 
