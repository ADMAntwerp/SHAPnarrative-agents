...
"""
This script is used to compute the faithfulness results. 
"""
...
def compute_faithfulness_agentic(experiments: list[Type[AgenticNarrativeExperiment]]) -> list[Type[ExperimentMetrics]]:
    def average_zero(df):
        ...
        accuracy= (80-(len(numeric_values)-num_zeros)) / 80 # 80 if 4 feature, 160, if 8 features
        return accuracy

    num_feat = 10 # this only controls how many columns will be shown in the df_diff table, not the number of features included in the narrative
    ...
    for experiment in experiments:
        ...
        for model_name, all_instances in experiment.extractions_dict.items():  
